...
public class OnlineLoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adpt = new ArrayAdapter(this, android.R.layout.simple_expandable_list_item_1, list_loginUsers);
    ...
    public void JoinOnlineGame() {
        ...
        b.setNegativeButton("Back", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                Intent intent = new Intent(getApplicationContext(), TicTacToeGame.class);
                startActivity(intent);
                finish();
            }
        });
